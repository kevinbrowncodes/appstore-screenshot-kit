...
that replays a key sequence at launch. One token per key press (digits
separately); `o:` / `b:` prefix the orange / blue shift.

| Raw file            | State                              | `DEMO_KEYS`                                  |
|---------------------|------------------------------------|----------------------------------------------|
| `01-mortgage.png`   | 30-yr, $400k @ 6.5% → PMT −2,528.27 | `3 6 0 N 6 . 5 I/YR 4 0 0 0 0 0 PV 0 FV PMT`          |
